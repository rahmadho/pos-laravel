...
<head>
  ...
  <link rel="stylesheet" href="{{asset('assets/libs/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css')}}">
  <link rel="stylesheet" href="{{asset('assets/libs/select2/dist/css/select2.min.css')}}">
  <link rel="stylesheet" href="{{asset('assets/libs/selectric/public/selectric.css')}}">
...
<body>
  ...
  <script src="{{asset('assets/libs/jquery.nicescroll/dist/jquery.nicescroll.min.js')}}"></script>
  ...
  <script src="{{asset('assets/libs/bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js')}}"></script>
  <script src="{{asset('assets/libs/bootstrap-timepicker/js/bootstrap-timepicker.min.js')}}"></script>
  <script src="{{asset('assets/libs/bootstrap-tagsinput/dist/bootstrap-tagsinput.min.js')}}"></script>
  <script src="{{asset('assets/libs/select2/dist/js/select2.full.min.js')}}"></script>
  <script src="{{asset('assets/libs/selectric/public/jquery.selectric.min.js')}}"></script>
